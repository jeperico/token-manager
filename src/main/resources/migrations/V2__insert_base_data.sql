...
('Acrobatics', 1, FALSE, TRUE, FALSE),
('Athletics', 4, FALSE, FALSE, FALSE),
('Current Affairs', 2, TRUE, FALSE, FALSE),
('Sciences', 2, TRUE, FALSE, FALSE),
('Crime', 1, TRUE, TRUE, TRUE),
('Diplomacy', 3, FALSE, FALSE, FALSE),
('Deception', 3, FALSE, FALSE, TRUE),
('Fortitude', 5, FALSE, FALSE, FALSE),
('Stealth', 1, FALSE, TRUE, FALSE),
...
('Medicine', 2, FALSE, FALSE, TRUE),
('Occultism', 2, TRUE, FALSE, FALSE),
('Perception', 3, FALSE, FALSE, FALSE),
('Piloting', 1, TRUE, FALSE, FALSE),
('Aim', 1, FALSE, FALSE, FALSE),
('Profession', 2, FALSE, FALSE, FALSE),
('Reflexes', 1, FALSE, FALSE, FALSE),
('Religion', 3, TRUE, FALSE, FALSE),
('Survival', 3, FALSE, FALSE, FALSE),
('Tactics', 2, TRUE, FALSE, FALSE),
('Technology', 2, TRUE, FALSE, TRUE),
